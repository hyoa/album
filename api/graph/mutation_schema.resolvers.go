...
func (r *mutationResolver) Create(ctx context.Context, input model.CreateInput) (*model.User, error) {
...
func (r *mutationResolver) Update(ctx context.Context, input model.UpdateInput) (*model.User, error) {
	if input.Role != nil {
